...
def main() -> pd.DataFrame:
    ...
    cols = ["idProduct", "firm", "product", "price", "shelf_price", "ad_price", "share_pct", "segment", "cals", "fat", "sugar"]
    ...
    first = ["idProduct", "firm", "product", "segment", "price", "share", "delta", "cals", "fat", "sugar"]
